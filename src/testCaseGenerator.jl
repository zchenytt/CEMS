...
let
    ...
    seed = 12094035092
    P_A = 25943 # TODO
    Q_A = [48422, 29747, 29559, 26684, 25169, 29918, 17247, 29543, 64744, 31058, 39705, 39942, 75730, 51951, 27502, 22945, 48659, 53854, 62325, 39843, 47179, 21693, 46750, 49190]
    E_Q = 431712
end
let
    K = 40
    ...
    seed = 200942002345
    P_A = 150840
    Q_A = [106614, 147419, 180810, 191408, 123487, 135966, 259935, 136015, 150486, 174222, 140659, 179228, 223559, 149084, 189448, 99982, 122348, 135848, 228898, 80867, 231175, 63998, 196619, 146400]
    E_Q = 2086961
end
