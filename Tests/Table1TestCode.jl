...
# This file is used to test block-virtual_CPU_core 1-to-1 cases
# test results are saved in Table1Data.jl in julia DataFrames

const K = 1;         # ⚙️ controls the problem scale
const LOG_TIME = 1; 
const my_seed = 8;                 Random.seed!(hash(my_seed));
const T = 24;
